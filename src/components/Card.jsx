...
const Card = ({ index, movie, isLiked = false }) => {
            ...
            <div className="info-container flex column">
              ...
              <div className="icons flex j-between">
                <div className="controls flex">
                  ...
                  {
                    isLiked ? (<BsCheck title="Remove From List" onClick={() => dispatch(removeUserLikedMovies({ movieID: movie.id, email: email }))} />)
              ...
              <div className="genres flex">
                <ul className="flex">{movie.genres.map((genre) =>
...
const Container = styled.div`
  ...
  .hover {
    ...
    border-shadow: rgba(0, 0, 0, 0.75) 0px 3px 10px;
